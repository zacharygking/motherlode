"""motherlode: prospect it, mine it, pan it, keep the paydirt.
...
from a teacher or a source, ``pan`` runs every sample through the checkers and keeps what passed. The output is the paydirt; the rejects are the tailings, kept with
