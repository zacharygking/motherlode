...
The gate: ``rubric`` (a rubric's text plus the spec of its dimensions), ``survey`` (``mask`` blinds an items
...
from .dataset import Dataset, read_dataset, read_jsonl, seal_dataset, truth_rows, verify_dataset, write_dataset, write_jsonl
...
__all__ = [
    ...
    "Dataset", "read_dataset", "read_jsonl", "seal_dataset", "truth_rows", "verify_dataset", "write_dataset", "write_jsonl",
    "build_grading_tool",
